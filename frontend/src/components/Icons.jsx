...
/* Lightweight, consistent line icons (inherit currentColor & size via props). */
const base = (size = 20) => ({
  width: size,
  height: size,
  viewBox: '0 0 24 24',
...
export const IconBox = ({ size }) => (
  <svg {...base(size)}><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>
);
...
export const IconReceipt = ({ size }) => (
  <svg {...base(size)}><path d="M4 2v20l2-1.5L8 22l2-1.5L12 22l2-1.5L16 22l2-1.5L20 22V2l-2 1.5L16 2l-2 1.5L12 2l-2 1.5L8 2 6 3.5 4 2Z"/><path d="M8 7h8"/><path d="M8 11h8"/><path d="M8 15h5"/></svg>
);

export const IconRevenue = ({ size }) => (
...
export const IconBolt = ({ size }) => (
  <svg {...base(size)}><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>
);
...
export const IconSun = ({ size }) => (
  <svg {...base(size)}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>
);
...
export const IconLogo = ({ size = 30 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" stroke="#fff" strokeWidth="1.8" strokeLinejoin="round"/>
    <path d="m3.3 7 8.7 5 8.7-5M12 22V12" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
